...
describe("counter", () => {
  ...
  it('calls remove prop function with index', () => {
    ...
    shallow(element).find('button').at(0).simulate('click');
  ...
  it('calls increment prop function with index', () => {
    ...
    shallow(element).find('button').at(1).simulate('click');
  ...
  it('calls decrement prop function with index', () => {
    ...
    shallow(element).find('button').at(2).simulate('click');
  ...
  it('calls reset prop function with index', () => {
    ...
    shallow(element).find('button').at(3).simulate('click');
